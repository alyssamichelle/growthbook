      ...
      items: [
        {
          ...
          className: "sidebar-icon-script-tag",
        },
        {
          type: "doc",
          id: "lib/js",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          id: "lib/nextjs",
          label: "Next.js",
          className: "sidebar-icon-nextjs",
        },
        {
          type: "doc",
          id: "lib/php",
          label: "PHP",
          className: "sidebar-icon-php",
        },
        {
          type: "doc",
          id: "lib/ruby",
          label: "Ruby",
          className: "sidebar-icon-ruby",
        },
        {
          type: "doc",
          id: "lib/python",
        ...
        },
        {
          ...
          id: "lib/kotlin-jvm",
          label: "Kotlin (JVM)",
          className: "sidebar-icon-kotlin-jvm",
        },
        {
          type: "doc",
          id: "lib/csharp",
          label: "C#",
          className: "sidebar-icon-csharp",
        },
        {
          type: "doc",
          id: "lib/go",
          label: "Go",
          className: "sidebar-icon-go",
        },
        {
          type: "doc",
          id: "lib/rust",
          label: "Rust",
          className: "pill-new sidebar-icon-rust",
        },
        {
          type: "doc",
          id: "lib/elixir",
          label: "Elixir",
          className: "sidebar-icon-elixir",
        },
      ],
    },
    {
